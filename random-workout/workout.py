from fitlek.fitlek.workout import END_CONDITIONS, TARGET_TYPES
            ...
            "workoutSegments": [
                {
                    ...
                    "workoutSteps": [
                        step.json() for step in self.workout_steps
                    ],
                }
            ]
        }
...
class WorkoutStep:
    def __init__(self, order, step_type, end_condition="lap.button", end_condition_value=None, target=None):
        """
        Valid end condition valules:
